...
def print_cow():
    print(" ___________ ")
    print(" \033[07m  BruteList.py! \033[27m                # \033[07mC\033[27mommon")
...
def version():
    ...
    print("\r\n	\033[1;31m[ BruteList.py ]  " + __version__ + "\033[1;m\r\n")
...
def improve_dictionary(file_to_open):
    ...
    print_to_file(file_to_open + ".BruteList.txt", unique_list_finished)
